...
<html>
    ...
    <body>
        ...
        <section style="padding-left:10px;padding-right:10px">
            ...
            <table>
                <tr><th style="text-align:left;padding-left:5px;font-size:22px;font-weight:300px"> Advisor </th></tr>
                <tr><td style="padding-left:15px;font-size:20px"> Dr. Priyanga Senanayake </td></tr>
            </table>
            <br>
            <table>
                <tr><th style="text-align:left;padding-left:5px;font-size:22px;font-weight:300px"> Group Members </th></tr>
                <tr><td style="padding-left:15px;font-size:20px"> Dr. Lasith Ihalagamage </td></tr>
                <tr><td style="padding-left:15px;font-size:20px"> Dr. Chinthaka Jayarathne </td></tr>
                <tr><td style="padding-left:15px;font-size:20px"> Dr. Chulaka Jayaweera </td></tr>
                <tr><td style="padding-left:15px;font-size:20px"> Dr. Nimashi Katuwawala </td></tr>
                <tr><td style="padding-left:15px;font-size:20px"> Dr. Amila Liyanage </td></tr>
            </table>
        </section>
